...
<html class="no-js" lang="en">
    ...
    <head>
        ...
        <link rel="stylesheet" href="http://foodland-env-1.2hyy9yyf8i.us-east-2.elasticbeanstalk.com/admin/css/piechartstyle.css">
        <!-- responsive CSS
                    ============================================ -->
        ...
        <script src="http://foodland-env-1.2hyy9yyf8i.us-east-2.elasticbeanstalk.com/admin/js/pieChart.js"></script>
